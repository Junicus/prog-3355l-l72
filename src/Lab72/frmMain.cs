...
public partial class frmMain : Form
{
    ...
    private void btnCargar_Click(object sender, EventArgs e)
    {
        ...
        lvData.Items.Clear();
        lvData.Items.AddRange(actividades.Select(p => new ListViewItem(new[] { p.FechaActividad.ToString("dd/MM/yyyy"), p.Estudiante, p.Descripcion, p.Puntaje.ToString(), p.Id.ToString() })).ToArray());
    }
    ...
    {
        var item = new ActividadEntity { Id = int.Parse( e.Item.SubItems[4].Text) };
    }
}
